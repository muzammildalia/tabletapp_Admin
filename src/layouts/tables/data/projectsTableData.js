...
export default function data() {
  ...
  Project.propTypes = {
    image: PropTypes.string.isRequired, // Assuming image is a string representing the image source
    name: PropTypes.string.isRequired,
  };

  Progress.propTypes = {
    color: PropTypes.string.isRequired, // Assuming color is a string representing the color
